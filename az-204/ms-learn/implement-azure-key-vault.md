...
> **Note:** It's recommended to use a system-assigned managed identity.
...
> **Note:** This unit contains a hands-on lab exercise. The exercise involves creating an Azure Key Vault, storing secrets using the Azure CLI, and building a .NET console application that can create and retrieve secrets from the key vault.
>
...
> - Clean up resources
>
> This exercise takes approximately **30 minutes** to complete and requires an Azure subscription.
